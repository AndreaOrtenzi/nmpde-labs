...
{
  // L2 norm (VectorTools::L2_norm) is the square root of the integral on the domain of |u_h(x) - u_{ex}(x)|^2
  // u_h(x) finite element function, u_{ex}(x) is an analytical function
  ...
  // Compute the integral of the difference between a fe function and an analytical function.
  // It's better not to use the same quadrature formula for solution and error computation. Error should be more precise.
